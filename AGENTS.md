...
This project is indexed by GitNexus as **ThinkingCoding** (4108 symbols, 10258 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
